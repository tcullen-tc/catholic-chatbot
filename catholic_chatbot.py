...
def prayer_mode():
    """Prayer mode - generate personalized Catholic prayers."""
    print("\n" + "="*70)
    print("🙏  PRAYER MODE  🙏")
    print("="*70)
    print("\nShare your prayer intention with details (names, situations, etc.)")
    print("The more specific you are, the more personal the prayer will be.")
    print("\n💡 Examples:")
    print("   • 'Pray for my grandmother Maria who is in the hospital'")
    print("   • 'Pray for guidance as I look for a new job'")
    print("   • 'Pray for peace in my family'")
    print("\nType 'exit' to return to the main menu.\n")
    
    while True:
        intention = input("✝️  What would you like to pray for? ")
        
        if intention.lower() in ['exit', 'quit', 'back']:
            print("\n🔙 Returning to main menu...\n")
            break
        
        if not intention.strip():
            print("Please share your prayer intention.\n")
            continue
...
PRAYER:"""
        ...
        try:
            ...
            # Show options after prayer
            print("\n" + "-"*50)
            print("📌 WHAT WOULD YOU LIKE TO DO NEXT?")
            print("-"*50)
            print("  1. Pray for another intention")
            print("  2. Return to Main Menu")
            print("  3. Exit the Chatbot")
            print("-"*50)
            ...
            while True:
                ...
                if next_choice == '1':
                    print("\n" + "="*50)
                    print("🔄 Starting new prayer...")
                    print("="*50 + "\n")
                    break  # Break inner loop to ask for new intention
                    
                elif next_choice == '2':
                    print("\n🔙 Returning to Main Menu...\n")
                    return  # Exit prayer_mode function
                    
                elif next_choice == '3':
                    print("\n" + "="*60)
                    print("🙏  May God bless you and keep you. Go in peace.  🙏")
                    print("="*60 + "\n")
            ...
            print(f"\n❌ Error generating prayer: {e}")
            print("\nPlease try again.\n")

def main():
    """Main entry point with clear menu options."""
    print("\n" + "="*60)
    print("    ✝️  WHAT WOULD JESUS SAY?  ✝️")
    print("="*60)
    print("\n📖 A Catholic guide for questions, reflection, and prayer.\n")
    print("-"*60)
    print("📌 MENU OPTIONS:")
    print("   1. Ask a Question - Get answers from Scripture and Church teaching")
    print("   2. Prayer Mode - Create a personalized Catholic prayer")
    print("   3. Quit - Exit the chatbot")
    print("-"*60)
    ...
    while True:
        ...
        if choice == '1':
            ...
            print("\n⚠️  Please enter 1 (Question), 2 (Prayer), or 3 (Quit).")
